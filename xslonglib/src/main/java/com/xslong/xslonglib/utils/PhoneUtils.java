...
public class PhoneUtils {
    ...
    public static void dial(String phoneNumber) {
        BaseApplication.getAppContext().startActivity(new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void call(String phoneNumber) {
        BaseApplication.getAppContext().startActivity(new Intent("android.intent.action.CALL", Uri.parse("tel:" + phoneNumber)));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(BaseApplication.getAppContext(), 0, new Intent(), 0);
