...
import com.xslong.xslonglib.utils.TimeUtil;
...
//        Log.d(TAG, "Rotate Picture by: " + rotation);
        getFragmentManager()
                ...
                .replace(
                        ...
                        EditSavePhotoFragment.newInstance(data, rotation, mImageParameters.createCopy(), TimeUtil.getCurrentDay()),
