...
public class EditSavePhotoFragment extends Fragment {
    ...
    public static Fragment newInstance(byte[] bitmapByteArray, int rotation,
                                       @NonNull ImageParameters parameters, String imgName) {
        ...
        args.putString(IMAGE_NAME, imgName);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        imgName = getArguments().getString(IMAGE_NAME);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ...
                Uri photoUri = ImageUtility.savePicture(getActivity(), bitmap, imgName);
