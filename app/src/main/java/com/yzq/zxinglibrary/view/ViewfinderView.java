...
public final class ViewfinderView extends View {
    ...
    private String drawText = "对准车身的二维码";//提示文字
    private int drawTextSize=40;//提示文字大小
    private int drawTextColor = Color.WHITE;//提示文字颜色
    private boolean drawTextGravityBottom = false;//提示文字位置
    private int drawTextMargin=100;//提示文字与扫描框距离
...
//    }
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
       // canvas.drawText("二维码扫描", frame.left + frame.width() / 2, frame.top + 40 * 1.5f, paint);
    }
...
//外景颜色
        maskColor = ContextCompat.getColor(getContext(), R.color.result_saoma);
    ...
    public void drawText(Canvas canvas, Rect frame) {
        ...
        float x = (width - textWidth) / 2;//文字开始位置
        //根据 drawTextGravityBottom 文字在扫描框上方还是下文，默认下方
        float y = drawTextGravityBottom ? frame.top + drawTextMargin : frame.top - drawTextMargin;
        canvas.drawText(drawText, x, y, paint);

//        paint.setColor(drawTextColor);
//        paint.setTextSize(drawTextSize);
//        paint.setTextAlign(Paint.Align.CENTER);
//        canvas.drawText(drawText, frame.top + frame.width() / 2, frame.top + 40 * 1.5f, paint);
    }
