...
public class LoginModel implements LoginContract.Model {
    ...
    @Override
    public Observable<BaseResponse<LoginEntity>> login(HashMap<String, String> params) {
        return  Api.getApiService().login(params);
    }

    @Override
    public Observable<BaseResponse> getSMSCode(HashMap<String, String> params) {

//        try {
//            Logger.w(Api.BASE_URL + "getPhoneCode?" + createLinkStringByGet(params));
//        }catch (Exception e) {
//            e.printStackTrace();
//        }

        return Api.getApiService().getSMSCode(params);
    }
